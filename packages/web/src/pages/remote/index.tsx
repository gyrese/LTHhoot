  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center gap-8 bg-gradient-to-b from-slate-950 to-black p-6">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-1/4 h-48 w-48 animate-pulse rounded-full bg-violet-500/6 blur-3xl [animation-delay:1.5s]" />
      </div>
      ...
      <div className="relative w-full max-w-xs rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-md">
        ...
        <input
          ...
          maxLength={8}
          className="mb-3 w-full rounded-xl border border-white/10 bg-white/8 px-4 py-3 text-center font-mono text-xl font-bold uppercase tracking-widest text-white placeholder-white/20 transition-all focus:border-orange-500/50 focus:bg-white/10 focus:outline-none"
          autoFocus
        />
