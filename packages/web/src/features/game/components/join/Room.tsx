  ...
  return (
    <div className="flex w-full flex-1 flex-col items-center justify-center p-4">
      ...
      >
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/20 bg-black/40 p-8 shadow-2xl backdrop-blur-2xl text-center">
          <div className="flex flex-col gap-8">
            <div className="space-y-2">
              ...
              <p className="text-sm font-medium text-white/50">
                {t("game:enterPinDesc", "Saisis le code PIN du salon pour commencer")}
              </p>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="group relative">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-white/10 bg-white/5 py-4 pl-12 pr-4 text-center text-3xl font-black tracking-[0.2em] text-white placeholder:text-white/10 placeholder:tracking-normal focus:border-primary/50 focus:bg-white/10 focus:outline-none focus:ring-4 focus:ring-primary/20"
                />
              </div>
