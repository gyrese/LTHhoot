...
const OpenAnswersReveal = ({
  data: { question, answers, totalPlayers },
}: Props) => {
  ...
  return (
    <div className="flex flex-1 flex-col items-center gap-5 overflow-y-auto px-4 py-6 pb-20">
      ...
      <div className="flex w-full max-w-4xl flex-wrap justify-center gap-3">
          ...
          >
            ...
            <span
              className={clsx(
                ...
                answer.isCorrect ? "text-white/80" : "text-white/50",
              )}
            >
              {answer.playerName}
            </span>
        ...
        {noAnswer > 0 && (
          <div className="flex flex-col items-center gap-1 rounded-2xl bg-white/5 px-5 py-3 text-center ring-1 ring-white/10">
